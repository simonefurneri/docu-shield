...
export default function UpgradeModal({ isOpen, onClose }: UpgradeModalProps) {
  ...
  return (
    ...
    >
      <div
        className="relative my-auto w-full max-w-2xl max-h-[90vh] flex flex-col rounded-2xl border border-slate-200 bg-white p-5 sm:p-8 shadow-2xl overflow-y-auto"
      ...
      >
        ...
        <div className="text-center pt-2 sm:pt-0">
          <div className="mx-auto mb-2 sm:mb-3 inline-flex h-10 w-10 sm:h-12 sm:w-12 items-center justify-center rounded-xl bg-indigo-50 text-indigo-600">
            <Sparkles className="h-5 w-5 sm:h-6 sm:w-6" />
          </div>
          <h2 className="text-xl font-bold text-slate-900 sm:text-3xl">
            Hai utilizzato la tua analisi gratuita
          </h2>
          <p className="mx-auto mt-1.5 sm:mt-2 max-w-lg text-xs sm:text-sm text-slate-600">
